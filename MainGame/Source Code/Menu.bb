...
Function UpdateLauncher()
	...
	Repeat
		...
		If DrawButton(LauncherWidth - 275, LauncherHeight - 50 - 55, 150, 30, "BUG REPORT", False, False, False) Then
		    ExecFile("https://discord.gg/Y5PTN7a2mC")
					
			End
		EndIf
		
		If DrawButton(LauncherWidth - 275, LauncherHeight - 50, 150, 30, "DISCORD", False, False, False) Then
		    ExecFile("https://discord.gg/Y5PTN7a2mC")
