...
Repeat
	...
	EndIf
	SetGadgetText(descr_label,("Description ("+(Len(TextAreaText(descr_text)))+"/250) :"))
	...
	EID=EventData() 
		...
		If EID=3 Then
			...
			EndIf
		EndIf
		If EID=6 Then ExecFile "https://steamcommunity.com/sharedfiles/filedetails/?id=2893925699"
		If EID=40  Then Notify "Map Creator SCPCBR v"+VersionNumber
		If EID=17 Then 
